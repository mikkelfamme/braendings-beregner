...
const expose=['finite','localParts','localToEpoch','addDays','dayBounds','ALL_PROGRAMS','DEFAULT_SETTINGS','factoryProgram','buildProgram','validateProfile','normalizePrices','calculate','findCheapest','hourlyPrices','priceBand','naturalPriceRangeLabel'];
...
await writeFile('dist/.nojekyll','');console.log('Built Braending 6.0.0. No credentials included.');
